...
<body>
    ...
    <div class="cloud floating">
        <img src="Img/cloud.png" alt="Scoop Themes">
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12">
                    ...
                    <br/>
                    <br/>
                    <h2 class="subtitle">Opps...page not found.</h2>
                    <br/>
                    <form class="form-inline validate signup" role="form">
                        ...
                        <input type="button" name="subscribe" value="返回首页" class="btn btn-theme to_index">
                    </form>
                    <br/>
                </div>

		...
		<form method="post" action="#">
			<div class="reg_context col-lg-4 col-sm-4 col-md-4">
				...
				<div class="form-group input_style">
					...
					<input type="email" class="form-control" id="email" name="useremail" placeholder="例如:netspider@yeah.net">
				</div>
				...
				<div class="form-group">
					...
					<input type="submit" value="注册" class="btn btn-primary btn-radius">
				</div>
